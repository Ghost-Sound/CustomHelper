using CustomHelper.Authentication.Options;
    ...
    public class TokenService : ITokenService
    {
        ...
        public TokenService(ILogger<TokenService> logger, IOptions<IdentityServerSettings> identityServerSettings)
        {
            ...
            if (_discoveryDocument.IsError)
            {
                ...
                throw new System.Exception("Unable to get discovery document", _discoveryDocument.Exception);
            }
        }
        ...
        public async Task<TokenResponse> GetToken(string scope)
        {
            ...
            if (tokenResponse.IsError)
            {
                ...
                throw new System.Exception("Unable to get token", tokenResponse.Exception);
            }
